...
typedef void (*compact_f) (Interp *, Memory_Pools *mem_pools, Variable_Size_Pool *);
...
static void
alloc_new_block(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools), size_t size, ARGMOD(Variable_Size_Pool *pool),
        ARGIN(const char *why))
{
...
PARROT_CANNOT_RETURN_NULL
void *
mem_allocate(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools), size_t size, ARGMOD(Variable_Size_Pool *pool))
{
...
void
compact_pool(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools), ARGMOD(Variable_Size_Pool *pool))
{
...
void
initialize_var_size_pools(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
...
=item C<static void check_memory_system(PARROT_INTERP, Memory_Pools *mem_pools)>
...
static void
check_memory_system(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
