...
static void
gc_inf_add_free_object(SHIM_INTERP, ARGIN(Memory_Pools *mem_pools), ARGMOD(Fixed_Size_Pool *pool),
    ARGIN(void *to_add))
{
...
PARROT_CANNOT_RETURN_NULL
static void *
gc_inf_get_free_object(SHIM_INTERP, ARGIN(Memory_Pools *mem_pools), ARGMOD(Fixed_Size_Pool *pool))
{
...
static void
gc_inf_alloc_objects(SHIM_INTERP, ARGIN(Memory_Pools *mem_pools), ARGMOD(Fixed_Size_Pool *pool))
{
...
static void
gc_inf_more_traceable_objects(SHIM_INTERP, ARGIN(Memory_Pools *mem_pools), ARGMOD(Fixed_Size_Pool *pool))
{
