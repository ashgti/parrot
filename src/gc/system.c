...
=item C<void trace_system_areas(PARROT_INTERP, Memory_Pools *mem_pools)>
...
void
trace_system_areas(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
...
=item C<static void trace_system_stack(PARROT_INTERP, Memory_Pools *mem_pools)>
...
static void
trace_system_stack(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
    ...
    trace_mem_block(interp, mem_pools, (size_t)lo_var_ptr, (size_t)&lo_var_ptr);
}

/*

=item C<static size_t get_max_buffer_address(PARROT_INTERP, Memory_Pools
*mem_pools)>
...
PARROT_WARN_UNUSED_RESULT
static size_t
get_max_buffer_address(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
...
=item C<static size_t get_min_buffer_address(PARROT_INTERP, Memory_Pools
*mem_pools)>
...
PARROT_WARN_UNUSED_RESULT
static size_t
get_min_buffer_address(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
...
=item C<static size_t get_max_pmc_address(PARROT_INTERP, Memory_Pools
*mem_pools)>
...
PARROT_WARN_UNUSED_RESULT
static size_t
get_max_pmc_address(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
...
=item C<static size_t get_min_pmc_address(PARROT_INTERP, Memory_Pools
*mem_pools)>
...
PARROT_WARN_UNUSED_RESULT
static size_t
get_min_pmc_address(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools))
{
...
=item C<static void trace_mem_block(PARROT_INTERP, Memory_Pools *mem_pools,
...
static void
trace_mem_block(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools),
        size_t lo_var_ptr, size_t hi_var_ptr)
{
...
=item C<static int is_buffer_ptr(PARROT_INTERP, Memory_Pools *mem_pools, const
void *ptr)>
...
PARROT_WARN_UNUSED_RESULT
static int
is_buffer_ptr(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools), ARGIN(const void *ptr))
{
...
=item C<static int is_pmc_ptr(PARROT_INTERP, Memory_Pools *mem_pools, const void
*ptr)>
...
PARROT_WARN_UNUSED_RESULT
static int
is_pmc_ptr(PARROT_INTERP, ARGIN(Memory_Pools *mem_pools), ARGIN(const void *ptr))
{
